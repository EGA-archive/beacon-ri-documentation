...
A total of 0 variants were skipped`}</code>
          ...
          <p className="note">
            ...
            <div>
              ...
              ri-tools/pipelines/default/templates and delete the
              population.json file. If your VCF does contain allele frequency
              fields but they are still being ignored, the issue may be due to
              mismatched field names. Make sure the field names in your VCF{" "}
              <b>exactly match</b> those defined in
